-- =========================================================================================
--  نظام رواتب وأجور ومختبرات مستشفى الفرح الأهلي الموحد (Al-Farrah Private Hospital)
--  كود الـ SQL الشامل والكامل لإنشاء وإعداد وتغذية قاعدة البيانات والربط من الصفر
--  (Microsoft SQL Server 2019+ / Unified Enterprise Database Schema)
--  إعداد المهندس: محمد جاسم محمد ابراهيم (الهاتف: 07836885808)
-- =========================================================================================

-- 1. إنشاء قاعدة البيانات وتحديد ترميز يدعم اللغة العربية بشكل مثالي
...
-- ابدأ معاملة برمجية لضمان الإنشاء الذري الكامل لجميع الجداول بدون أخطاء
BEGIN TRANSACTION;
BEGIN TRY
    ...
    BEGIN
        ...
        PRINT 'SUCCESS: Created table dbo.Hospital_Departments';
    END;
    ...
    -- =========================================================================================
    -- 3. جدول الموظفين والمنتسبين الكلي (Hospital_Employees)
    -- =========================================================================================
    ...
    BEGIN
        ...
        PRINT 'SUCCESS: Created table dbo.Hospital_Employees';
    END
    ELSE
    BEGIN
    ...
    BEGIN
        ...
        PRINT 'SUCCESS: Created table dbo.Hospital_Archive';
    END
    ELSE
    BEGIN
    ...
    -- =========================================================================================
    -- 5. جدول إعدادات النظام العامة والمستخدمين وصلاحياتهم (Hospital_Settings)
    -- =========================================================================================
    ...
    BEGIN
        ...
        PRINT 'SUCCESS: Created table dbo.Hospital_Settings';
    END
    ELSE
    BEGIN
    ...
    -- =========================================================================================
    -- 6. جدول ملف المريض والربط مع طبلة المريض (Lab_Patients)
    -- =========================================================================================
    ...
    -- =========================================================================================
    -- 7. جدول أرشيف البصمات والصور الحيومترية (Lab_Biometrics_Archive)
    -- =========================================================================================
    ...
    -- =========================================================================================
    -- 8. جدول عينات التحليل وباركودات الأنابيب (Lab_Samples)
    -- =========================================================================================
    ...
    -- =========================================================================================
    -- 9. جدول سجلات مطابقات نقل الدم وأمان الحقن (Blood_Transfusion_Logs)
    -- =========================================================================================
    ...
    -- =========================================================================================
    -- 10. جدول أرشفة مواد وكتب ومستلزمات المختبر (Lab_Materials)
    -- =========================================================================================
    ...
    COMMIT TRANSACTION;
    PRINT 'SUCCESS: Unified Database Schema applied successfully!';
